...
@NamedQueries({
    ...
    @NamedQuery(name = "Aurreikuspena.findByMota", query = "SELECT a FROM Aurreikuspena a WHERE a.mota = :mota"),
...
public class Aurreikuspena implements Serializable {
    ...
    public Aurreikuspena(Short iDaurreikuspena, String errepidea, String mota, String probintzia, String herria, String data, BigDecimal lat, BigDecimal lng, float tenperatura, float haizea, float prezipitazioa, float hasieraKm, float amaieraKm) {
        this.iDaurreikuspena = iDaurreikuspena;
