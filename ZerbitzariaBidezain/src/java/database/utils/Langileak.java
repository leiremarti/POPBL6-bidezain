...
public class Langileak implements Serializable {
    ...
    public Langileak(Short iDlangilea) {
        this.iDlangilea = iDlangilea;
    }

    public Langileak(Short iDlangilea, String izena, String abizena, BigDecimal erabiltzailea, byte[] passwordHash, byte[] passwordSalt, String eposta) {
        this.iDlangilea = iDlangilea;
        this.izena = izena;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Langileak)) {
            return false;
        }
        Langileak other = (Langileak) object;
