...
-- Volcando datos para la tabla bidezain_db.aurreikuspena: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bidezain_db.erabiltzailea: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla bidezain_db.intzidentzia_mota: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla bidezain_db.langilea: ~13 rows (aproximadamente)
